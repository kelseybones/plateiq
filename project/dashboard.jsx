// Dashboard / Home screen — multiple layout variants
...
// Toggle between list view and meal-grouped view
...
// Layout: split (ring + bar side-by-side hero)
...
// Layout: stacked (calories number-led, no big ring)
...
const Dashboard = ({ data, layout, onLog, onMeal, view, onView, onOpenMeal }) => {
...
// Meal detail screen — list items in this meal slot, allow add more / tap to edit
const MealDetail = ({ slotId, meals, onBack, onEdit, onAdd, onDelete }) => {
...
Object.assign(window, { Dashboard, MealRow, MacroBar, MealDetail, MEAL_SLOTS });
