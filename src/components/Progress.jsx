...
const Progress = ({ data }) => {
  ...
  const goal = metric === "kcal" ? data.calorieGoal : metric === "protein" ? data.pGoal : metric === "carbs" ? data.cGoal : data.fGoal;
  ...
  return (
    <div style={{ padding: "0 0 110px" }}>
      ...
      <div style={{ padding: "0 20px 16px" }}>
        ...
        <div className="card" style={{ padding: "4px 18px" }}>
          <WeeklyRow label="Mon" kcal={2750} pct={Math.round(2750/data.calorieGoal*100)}/>
          <WeeklyRow label="Tue" kcal={2820} pct={Math.round(2820/data.calorieGoal*100)}/>
          <WeeklyRow label="Wed" kcal={data.consumed} pct={Math.round(data.consumed/data.calorieGoal*100)} today/>
